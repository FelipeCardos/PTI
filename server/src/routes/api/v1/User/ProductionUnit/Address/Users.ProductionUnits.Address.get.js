...
const { FindProductionUnits } = require("../../../../../controllers/ProductionUnit/findProductionUnit");
const { checkAuthenticated, checkUsersIsAdminOrProducer } = require("../../../../../middleware/UserAuth");


router.get('/', checkAuthenticated, checkUsersIsAdminOrProducer, async (req, res) => {
